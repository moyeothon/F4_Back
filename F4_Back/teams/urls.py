...
urlpatterns = [
    ...
    # 프로필 생성
    path('teams/<int:team_id>/profile/', ProfileCreateAPIView.as_view(), name='profile-create'),

    # 프로필 조회
    path('teams/<int:team_id>/profile/<int:profile_id>/', ProfileDetailAPIView.as_view(), name='profile-detail'),
]